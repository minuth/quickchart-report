...
class BarChartService extends chart_service_1.BaseChartService {
    ...
    generateChart() {
        return __awaiter(this, void 0, void 0, function* () {
            const { openIssues, closedIssues, openPullRequest, closedPullRequest, mergedPullRequest, stargazers, forks, collaborators } = this.report;
            const charData = {
                type: 'bar',
                data: {
                    datasets: [
                        { label: 'Open issues', data: [(openIssues === null || openIssues === void 0 ? void 0 : openIssues.totalCount) || 0] },
                        { label: 'Closed issues', data: [(closedIssues === null || closedIssues === void 0 ? void 0 : closedIssues.totalCount) || 0] },
                        {
                            label: 'Open pull requests',
                            data: [(openPullRequest === null || openPullRequest === void 0 ? void 0 : openPullRequest.totalCount) || 0]
                        },
                        {
                            label: 'Closed pull requests',
                            data: [(closedPullRequest === null || closedPullRequest === void 0 ? void 0 : closedPullRequest.totalCount) || 0]
                        },
                        {
                            label: 'Merged pull requests',
                            data: [(mergedPullRequest === null || mergedPullRequest === void 0 ? void 0 : mergedPullRequest.totalCount) || 0]
                        },
                        { label: 'Forks', data: [(forks === null || forks === void 0 ? void 0 : forks.totalCount) || 0] },
                        { label: 'Collaborators', data: [(collaborators === null || collaborators === void 0 ? void 0 : collaborators.totalCount) || 0] },
                        { label: 'Stargazers', data: [(stargazers === null || stargazers === void 0 ? void 0 : stargazers.totalCount) || 0] }
                    ]
                },
                options: {
                    plugins: {
            ...
            const chartBuffer = yield this.downloadChart(JSON.stringify(charData));
            (0, fs_1.writeFileSync)(this.saveChartFilePath, chartBuffer);
        });
    }
}
...
class BaseChartService {
    ...
    downloadChart(chartData) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield axios_1.default.post(this.BASE_URL, {
                chart: chartData,
